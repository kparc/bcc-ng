...
ZK O2(I t,I f,I r,K x,K y){I i=Ay?yi:yu; //!< y is either value or function name
 R u(r,j3(Ay?c0():y,x,
  10>f?o2(t,f,r,xu,i):j2(cm(t,xu,i),16>r?cc(f-9,r):c1(f-9))));} //!< comparison or function call (^ is ops|conds boundary in U())
...
K d(I r,K x){
 ...
 S((y=xy,c(a=*xC)),
  ...
  P(3>xn,
   ...
   O2(0,'#'==a?-3:'*'==a?1+hh(y):'/'==a?4:U(a),s,e(s,y),kc(128+('#'==a?-1:'*'!=a))))
